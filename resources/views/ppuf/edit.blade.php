                ...
                <form action="{{ route('ppuf.update', $ppuf->id) }}" method="post">
                    ...
                    <div class="form-row">
                        <div class="col-12 col-lg-6 mb-3">
                            ...
                            <select class="w-100 border rounded selectpicker @error('role_id') is-invalid @enderror" id="role_id" name="role_id" data-live-search="true" required>
                                <option>Pilih Unit Pengaju</option>
                                @foreach ($roles as $role)
                                <option value="{{ $role->id }}" {{ old('role_id', $ppuf->role_id) == $role->id ? 'selected' : '' }}>
                                    {{ $role->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 col-lg-6 mb-3">
                            ...
                            <input type="type" class="form-control @error('ppuf_number') is-invalid @enderror" id="ppuf_number" name="ppuf_number" required value="{{ old('ppuf_number', $ppuf->ppuf_number) }}">
                            @error('ppuf_number')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-12 col-lg-6 mb-3">
                            ...
                            <textarea class="form-control @error('program_name') is-invalid @enderror" id="program_name" name="program_name" required>{{ old('program_name', $ppuf->program_name) }}</textarea>
                            @error('program_name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea rows="5" class="form-control @error('description') is-invalid @enderror" id="description" name="description" required>{{ old('description', $ppuf->description) }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('place') is-invalid @enderror" id="place" name="place" required value="{{ old('place', $ppuf->place) }}">
                            @error('place')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <select class="w-100 border rounded selectpicker @error('date') is-invalid @enderror" id="date" name="date" data-live-search="true" required>
                                ...
                                <option value="{{ $activity_date }}" {{ old('date', $ppuf->date) == $activity_date ? 'selected' : '' }}>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <select class="w-100 border rounded selectpicker @error('activity_type') is-invalid @enderror" id="activity_type" name="activity_type" data-live-search="true" required>
                                <option>Pilih Jenis Program</option>
                                @foreach ($program_types as $program_type)
                                <option value="{{ $program_type }}" {{ old('activity_type', $ppuf->activity_type) == $program_type ? 'selected' : '' }}>
