                ...
                <form action="{{ route('submission.update', $submission->id) }}" method="post">
                    ...
                    <div class="form-row">
                        <div class="col-12 col-lg-2 mb-3">
                            ...
                            <select class="w-100 border rounded form-control  @error('ppuf_id') is-invalid @enderror" id="ppuf_id" name="ppuf_id" data-live-search="true" required>
                                <option>{{ $submission->ppuf->ppuf_number }}</option>
                            </select>
                        </div>
                        <div class="col-12 col-lg-4 mb-3">
                            <label for="ppuf_name">Nama Kegiatan</label>
                            <select class="w-100 border rounded custom-select" id="ppuf_name" name="ppuf_name">
                                <option>{{ $submission->ppuf->program_name }}</option>
                            </select>
                        </div>
                        <div class="col-12 col-lg-3 mb-3">
                            <label for="rab">RAB Kegiatan</label>
                            <select class="w-100 border rounded custom-select" id="rab" name="rab">
                                <option>{{ $submission->ppuf->budget }}</option>
                            </select>
                        </div>
                        <div class="col-12 col-lg-3 mb-3">
                            ...
                            <select class="w-100 border rounded custom-select" id="activity_type" name="activity_type">
                                <option>{{ ucfirst($submission->ppuf->activity_type) }}</option>
                            </select>
                        </div>
                        <div class="col-12 mb-3">
                            <label for="background">Latar Belakang</label>
                            <textarea rows="4" class="form-control @error('background') is-invalid @enderror" id="background" name="background" required>{{ old('background', $submission->background) }}</textarea>
                            @error('background')
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <select class="custom-select w-100 border rounded @error('iku1_id') is-invalid @enderror" id="iku1_id" name="iku1_id" data-live-search="true" required>
                                <option>Pilih IKU</option>
                                @foreach ($ikus['iku1'] as $iku)
                                <option value="{{ $iku->id }}" {{ old('iku1_id', $submission->iku1_id) == $iku->id ? 'selected' : '' }}>
                                    {{ $iku->iku }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <select class="custom-select w-100 border rounded @error('iku2_id') is-invalid @enderror" id="iku2_id" name="iku2_id" data-live-search="true" required>
                                <option>Pilih IKU</option>
                                @foreach ($ikus['iku2'] as $iku)
                                <option value="{{ $iku->id }}" {{ old('iku2_id', $submission->iku2_id) == $iku->id ? 'selected' : '' }} data-chained="{{ $iku->parent_id }}">
                                    {{ $iku->iku }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <select class="custom-select w-100 border rounded @error('iku3_id') is-invalid @enderror" id="iku3_id" name="iku3_id" data-live-search="true" required>
                                <option>Pilih IKU</option>
                                @foreach ($ikus['iku3'] as $iku)
                                <option value="{{ $iku->id }}" {{ old('iku3_id', $submission->iku3_id) == $iku->id ? 'selected' : '' }} data-chained="{{ $iku->parent_id }}">
                                    {{ $iku->iku }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('vendor') is-invalid @enderror" id="vendor" name="vendor" required value="{{ old('vendor', $submission->vendor) }}">
                            @error('vendor')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('place') is-invalid @enderror" id="place" name="place" required value="{{ old('place', $submission->place) }}">
                            @error('place')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <select class="w-100 border rounded selectpicker @error('date') is-invalid @enderror" id="date" name="date" data-live-search="true" required>
                                <option>Pilih Waktu</option>
                                @foreach ($activity_dates as $activity_date)
                                <option value="{{ $activity_date }}" {{ old('date', $submission->date) == $activity_date ? 'selected' : '' }}>
