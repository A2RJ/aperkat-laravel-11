...
<div class="row">
    <div class="col-12">
        <div class="card shadow mb-4">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="btn btn-sm btn-success mr-1 mb-1" href="#" data-toggle="modal" data-target="#editModal{{ $period->id }}">
                                            <i class="fas fa-fw fa-edit"></i>
                                        </a>

                                        <form action="{{ route('disbursement-period.destroy', $period->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
            ...
            <!-- Add Modal-->
            <div class="modal fade" id="addModal" tabindex="-1" period="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <form action="{{ route('disbursement-period.store') }}" method="post">
                                ...
                                <div class="form-row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('period') is-invalid @enderror" id="period" name="period" required>
                                        @error('period')
            ...
            {{-- Edit modal --}}
            @foreach ($periods as $period)
            <div class="modal fade" id="editModal{{ $period->id }}" tabindex="-1" period="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" period="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Form Periode Pencairan</h5>
                        ...
                        <div class="modal-body">
                            <form action="{{ route('disbursement-period.update', ['disbursement_period' => $period->id]) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="form-row">
                                    <div class="col-12 mb-3">
                                        <label for="period">period</label>
                                        <input type="text" class="form-control @error('period') is-invalid @enderror" id="period" name="period" required value="{{ $period->period }}">
                                        @error('period')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
