                ...
                <form action="{{ route('submission.store') }}" method="post">
                    ...
                    <div class="form-row">
                        <div class="col-12 col-lg-2 mb-3">
                            ...
                            <select class="w-100 border rounded selectpicker @error('ppuf_id') is-invalid @enderror" id="ppuf_id" name="ppuf_id" data-live-search="true" required>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea rows="4" class="form-control @error('background') is-invalid @enderror" id="background" name="background" required>{{ old('background') }}</textarea>
                            @error('background')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('vendor') is-invalid @enderror" id="vendor" name="vendor" required value="{{ old('vendor') }}">
                            @error('vendor')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
