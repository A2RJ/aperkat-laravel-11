                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="btn btn-sm btn-success mr-1 mb-1" href="#" data-toggle="modal" data-target="#editModal{{ $role->id }}">
                            ...
                            <form action="{{ route('role.store') }}" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-12 mb-3 d-flex flex-column">
                                        ...
                                        <select class="w-100 border rounded selectpicker @error('parent_id') is-invalid @enderror" id="parent_id" name="parent_id" data-live-search="true" required>
                                    ...
                                    <div class="col-12 mb-3 d-flex flex-column">
                                        ...
                                        <select class="w-100 border rounded selectpicker @error('user_id') is-invalid @enderror" id="user_id" name="user_id" data-live-search="true" required>
                                ...
                                <div class="d-flex justify-content-between">
                                    <button class="btn bg-secondary btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn bg-primary btn-primary">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="modal-body">
                            <form action="{{ route('role.update', ['role' => $role->id]) }}" method="post">
                                ...
                                <div class="form-row">
                                    <div class="col-12 mb-3">
                                        <label for="role">Role</label>
                                        <input type="text" class="form-control @error('role') is-invalid @enderror" id="role" name="role" required value="{{ $role->role }}">
                                        @error('role')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="col-12 mb-3 d-flex flex-column">
                                        ...
                                        <select class="w-100 border rounded selectpicker @error('parent_id') is-invalid @enderror" id="parent_id" name="parent_id" data-live-search="true" required>
                                            <option>Choose Supervisor</option>
                                            @foreach ($supervisors as $supervisor)
                                            <option value="{{ $supervisor->id }}" {{ $role->role == $supervisor->role ? 'disabled' : '' }} {{ $role->parent?->role == $supervisor->role ? 'selected' : '' }}>
                                                {{ $supervisor->role }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 mb-3 d-flex flex-column">
                                        ...
                                        <select class="w-100 border rounded selectpicker @error('user_id') is-invalid @enderror" id="user_id" name="user_id" data-live-search="true" required>
                                            <option>Choose User</option>
                                            @foreach ($users as $user)
                                            <option value="{{ $user->id }}" {{ $role->user?->name == $user->name ? 'selected' : '' }}>
                                                {{ $user->name }}
                                            </option>
                                            @endforeach
                                        </select>
